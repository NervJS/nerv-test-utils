...
function isElement(instance) {
    return React.isValidElement(instance);
}
...
export { Simulate, renderIntoDocument, isElementOfType, isCompositeComponentWithType, isCompositeComponent, isCompositeComponentElement, findAllInRenderedTree, mockComponent, batchedUpdates, createRenderer };
export default {
    Simulate,
    renderIntoDocument,
    isElementOfType,
